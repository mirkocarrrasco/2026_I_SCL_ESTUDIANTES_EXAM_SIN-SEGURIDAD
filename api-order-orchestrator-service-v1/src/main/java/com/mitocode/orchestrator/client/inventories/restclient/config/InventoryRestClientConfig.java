package com.mitocode.orchestrator.client.inventories.restclient.config;
...
public class InventoryRestClientConfig {
    ...
    @Bean
    public RestClient shipmentV1RestClient(
            @Value("${http-clients.internal.api-inventory-service-v1.base-url}")
            String baseUrl,
