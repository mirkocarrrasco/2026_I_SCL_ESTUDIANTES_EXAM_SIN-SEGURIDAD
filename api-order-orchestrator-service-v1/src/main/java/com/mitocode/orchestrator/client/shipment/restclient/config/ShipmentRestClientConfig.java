package com.mitocode.orchestrator.client.shipment.restclient.config;
...
@Configuration
public class ShipmentRestClientConfig {

    @Bean
    public RestClient shipmentRestClient(
            @Value("${http-clients.internal.api-shipment-service-v1.base-url}")
            String baseUrl,
